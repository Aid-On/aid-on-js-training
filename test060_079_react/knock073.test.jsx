...
import { Knock073 } from "../src060_079_react/Knock073";
import { TrainingSkipError } from "../src020_039/common/TrainingSkipError";

describe("Knock073 React test", () => {
  beforeEach(() => {
    jest.useFakeTimers();
  });
  ...
  it("円が描画領域内に収まり続けることを確認", () => {
    ...
    render(<Knock073 width={width} height={height} radius={radius} />);
    const circles = document.querySelectorAll("circle");
  ...
  it("カスタムの更新間隔でアニメーションが動作する", () => {
    const intervalMs = 20;
    render(<Knock073 intervalMs={intervalMs} />);
    const circles = document.querySelectorAll("circle");
  ...
  it("カスタムの初期位置と速度で円が動作する", () => {
    ...
    render(<Knock073 initialCircles={customCircles} />);
    const circles = document.querySelectorAll("circle");
